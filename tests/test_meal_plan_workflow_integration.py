...
from src.nutrition.meal_plan_formatter import (
    format_meal_plan_as_markdown,
    generate_meal_plan_document,
)
from src.nutrition.error_logger import MealPlanErrorLogger
...
class TestMealPlanValidation:
    ...
    def test_structure_validation_passes_for_valid_plan(self) -> None:
        ...
        from src.nutrition.validators import validate_meal_plan_structure
